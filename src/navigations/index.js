...
import Certificates from '../screens/my-certificates';
import CertificateDetails from '../screens/my-certificate-details';
...
export default function AppNavigator() {
  return (
    <Stack.Navigator
      ...
      <Stack.Screen name="CertificateScreen" component={Certificates} />
      <Stack.Screen name="CertificateDetailsScreen" component={CertificateDetails} />
    </Stack.Navigator>
  );
}
